        ...
        <div className={styles.demoItemsContainer}>
          <div className={styles.demoItem}>
            ...
            <p className={styles.textHolder}>
              ...
              is to save all the useful links and resources, which were given in
              lesson or in Slack, in the Heroku database. The difficult part is
              updating the whole page after creating a new item. I use React
              Router to make the homepage and content page. It also comes with
              dark/light theme.
            </p>
          </div>
          <div className={styles.demoItem}>
            ...
            <p className={styles.textHolder}>
              ...
              system, users can attend events and the information will be saved
              in MongoDB. Users can also create a new event and let others to
              join it.
            </p>
          </div>
        </div>
