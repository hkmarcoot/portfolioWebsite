        ...
        <div className={styles.achieveItemsContainer}>
          <div className={styles.achieveItem}>
            ...
            <p className={styles.textHolder}>
              ...
              what I learned and the tactics that I used in teaching 3-12 years
              old children about MIT Scratch.
            </p>
          </div>
          <div className={styles.achieveItem}>
            <a
            ...
            <p className={styles.textHolder}>
              Joined the App Inventor Competition in adult track and won the 3rd
              place by creating a Covid-19 Hong Kong Information Center app.
            </p>
          </div>
          <div className={styles.achieveItem}>
            <a
            ...
            <p className={styles.textHolder}>
              The challenge kept step with the bootcamp, which was 117 days from
              the start of bootcamp to the end of it on 11th March 2022.
            </p>
          </div>
        </div>
      </div>
